...
latex_documents = [
    (master_doc, 'xf_utils_hw.tex', 'Vitis Utility Library',
     'Xilinx', 'manual'),
]
...
man_pages = [
    (master_doc, 'xf_utils_hw', 'Vitis Utility Library',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xf_utils_hw', 'Vitis Unless Library',

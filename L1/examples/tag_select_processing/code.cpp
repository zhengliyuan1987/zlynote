...
int test() {
    ...
    xf::common::utils_hw::stream_dup<ap_uint<W_TAG>, 2>(tg_strm, e_tg_strm, du_tag_strms, e_du_tag_strms);
    // process
    test_core(istrm, e_istrm, du_tag_strms, e_du_tag_strms, ostrm, e_ostrm);

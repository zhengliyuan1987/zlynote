...
.. _guide-stream_combine_msb:

*****************************************
Internals of stream_combine_msb
*****************************************
...
This document describes the structure and execution of stream_combine from MSB,
implemented as :ref:`stream_combine <cid-xf::common::utils_hw::stream_combine>` function.

.. image:: /images/stream_combine/stream_combine_msb.png
   :alt: combination n streams to one from MSB Structure
   :width: 80%
   :align: center

The stream_combine combines n streams into one stream. Combination from MSB means filling output data from the highest bit. 

...
sys.path.insert(1, os.path.abspath(os.path.dirname(shutil.which('doxyrest')) \
                                   + '/../share/doxyrest_b/sphinx'))
...
#html_favicon = '_static/xilinx-favicon.ico'
...
htmlhelp_basename = 'XFUTILSHWDOC'

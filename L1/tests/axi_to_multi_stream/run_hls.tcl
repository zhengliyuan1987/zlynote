...
add_files test_axi_to_multi_stream.cpp -cflags "-std=gnu++0x -g ${XF_PROJ_ROOT}/L1/include"
add_files -tb  test_axi_to_multi_stream.cpp -cflags "-std=gnu++0x -g ${XF_PROJ_ROOT}/L1/include"

...
void test_core_split_lsb(hls::stream<ap_uint<WIN_STRM> >& istrm,
                         hls::stream<bool>& e_istrm,
                         hls::stream<ap_uint<WOUT_STRM> > ostrms[NSTRM],
                         hls::stream<bool>& e_ostrm) {
    xf::common::utils_hw::stream_split<WIN_STRM, WOUT_STRM, NSTRM>(istrm, e_istrm, ostrms, e_ostrm,
...
int test_split_lsb() {
    ...
    test_core_split_lsb(data_istrm, e_data_istrm, data_ostrms, e_data_ostrm);
    int nerror = 0;

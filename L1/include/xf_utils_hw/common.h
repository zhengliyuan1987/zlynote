...
#pragma HLS inline
  ap_uint<128> x0 = y;
  ap_uint<128> x1 =
      (x0 & 0x5555555555555555) + ((x0 & 0xaaaaaaaaaaaaaaaa) >> 1);
  ap_uint<128> x2 =
      (x1 & 0x3333333333333333) + ((x1 & 0xcccccccccccccccc) >> 2);
  ap_uint<128> x3 =
      (x2 & 0x0f0f0f0f0f0f0f0f) + ((x2 & 0xf0f0f0f0f0f0f0f0) >> 4);
  ap_uint<128> x4 =
      (x3 & 0x00ff00ff00ff00ff) + ((x3 & 0xff00ff00ff00ff00) >> 8);
  ap_uint<128> x5 =
      (x4 & 0x0000ffff0000ffff) + ((x4 & 0xffff0000ffff0000) >> 16);
  ap_uint<128> x6 =
      (x5 & 0x00000000ffffffff) + ((x5 & 0xffffffff00000000) >> 32);

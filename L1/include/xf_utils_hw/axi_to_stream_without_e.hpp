...
/**
 * @file axi_to_stream_without_e.hpp
 * @brief This file provides loading data from AXI master to stream APIs.
 *
 * This file is part of Vitis Utility Library.
 */

#ifndef XF_UTILS_HW_AXI_TO_STREAM_WITHOUT_E_H
#define XF_UTILS_HW_AXI_TO_STREAM_WITHOUT_E_H
...
#endif // XF_UTILS_HW_AXI_TO_STREAM_WITHOUT_E_H

...
#pragma HLS LOOP_TRIPCOUNT min=1 max=1
		...
		for(int t=0; t<_NT; t++){
#pragma HLS UNROLL
		is_onetype_fnl[t]=details::axi_batchdata_to_stream<_WAxi, _BstLen >(
		   rbuf,
		   off_axi [t],
		   len_vec [t],
		   pos_vec [t],

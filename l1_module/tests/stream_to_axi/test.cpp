...
#pragma HLS INTERFACE m_axi depth=512 port=wbuf offset=slave bundle=gmem0 num_read_outstanding=32 num_write_outstanding=32 max_read_burst_length=16 max_write_burst_length=16
	xf::util::level1::strm_to_axi<WAxi, WStrm>(wbuf,istrm,e_strm);
}
